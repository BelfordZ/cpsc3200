// this is a network flow problem.  There are two algorithms, and O(n^3)
// algorithm is definitely out.  O(fm) is okay because the flow is likely
// not too large (and there is a 5 second limit)
